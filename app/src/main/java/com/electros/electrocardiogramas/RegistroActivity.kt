...
import kotlinx.android.synthetic.main.activity_registro.contra2
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        correoid.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                if(correoid.length() > 8 && contrasenaId.length() >5 && contra2.length() >5){
        ...
        contrasenaId.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                if(contrasenaId.length() > 5 && correoid.length() >8 && contra2.length() >5){
                    buttonRegistro.setBackgroundColor(Color.parseColor("#0c18f1"))
                    buttonRegistro.setTextColor(Color.parseColor("#ffffff"))
                    buttonRegistro.isEnabled = true
                }else{
        ...
        contra2.addTextChangedListener(object : TextWatcher {
            override fun beforeTextChanged(s: CharSequence?, start: Int, count: Int, after: Int) {
                Log.i("begoskndksjnj", "not overide")
            }
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
        ...
        buttonRegistro.setOnClickListener {
            if (contrasenaId.text.toString() != contra2.text.toString()){
